...
_CONFIG_SPEC: dict[str, str] = {
    ...
    "CAPITAL_GATE_ENABLE": "false", "CAPITAL_GATE_FLOOR": "20000", "CAPITAL_GATE_MAX_RISK_PCT": "15", "FF_SIZING_ENABLE": "true", "FF_RISK_PCT": "1.0",
...
def api_mode_advice():
    ...
    if eq < 1500:
        ...
        rows = [("ALGO_SIZE_STANDDOWN", "true", "false", "safe กันเกินเพดาน(ข้ามไม้) · growth เข้าทุกไม้ให้พอร์ตโต"),
                ...
                ("FORCE_CLOSE_MIN_CAPITAL", "20000", "20000", "force-close บังคับเปิดถาวร · lock ทุก double จนทุนถึงค่านี้"),
        ...
        rows = [("ALGO_SIZE_STANDDOWN", "true", "false", "safe กัน over-risk · growth เข้าทุกไม้ (พอร์ตถึงจะโต)"),
                ...
                ("FORCE_CLOSE_MIN_CAPITAL", "20000", "20000", "บังคับเปิด · lock double จนทุนถึง 20k (ทุน ≥ = ปล่อยวิ่งเอง)"),
        ...
        rows = [("MOM_LET_RUN", "true", "true", "ปล่อยถึง TP (+EV) ทั้งคู่"),
                ...
                ("FORCE_CLOSE_MIN_CAPITAL", "20000", "20000", "บังคับเปิด · ใกล้เกณฑ์ 20k = จะปล่อยวิ่งเร็วๆนี้")]
    elif eq < 30000:
