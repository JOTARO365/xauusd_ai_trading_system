...
| `SR_BREAKOUT_ALGOS` | `regime_momentum,regime_momentum_fvg,macro_momentum,confluence_15m,tsmom_d1` | Algos exempt from the S/R gate (they trade breakouts through levels). Everything else is gated on all pairs. |
