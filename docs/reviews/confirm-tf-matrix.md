...
| mean_reversion | rev | H1 | **M15** | -0.009 | -0.009 | -0.174 | · | · |
...
| macro_momentum | GBPUSD | -0.063 | +0.003 | -0.009 | -0.006 | +0.016 |
...
| mean_reversion | BTCUSD | -0.125 | -0.009 | +0.050 | +0.135 | +0.020 |
...
| mean_reversion | XAUJPY | -0.023 | -0.039 | -0.174 | · | · |
...
| sweep_reversal | GBPUSD | -0.135 | -0.008 | -0.077 | +0.064 | +0.095 |
...
| sweep_reversal | XAUEUR | -0.148 | -0.004 | -0.026 | +0.063 | -0.275 |
