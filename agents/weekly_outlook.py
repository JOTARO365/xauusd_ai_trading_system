...
⏱️ จังหวะ/โซนที่ควรปล่อยให้ algo เข้า (สำคัญ — กันพอร์ตเล็กแตก): ต่อ algo ที่แนะนำ ให้เพิ่ม 1 บรรทัดย่อย
"จังหวะ:" อ้างโซนแนวรับ/แนวต้านจากหัวข้อ 📐 ข้างบน — algo ฝั่ง buy/long ควรเข้าเมื่อราคาอยู่**ใกล้แนวรับ**ของสัปดาห์
(ไม่ใช่ไล่ซื้อที่แนวต้าน) · ฝั่ง sell/short เมื่อราคาอยู่**ใกล้แนวต้าน** (ไม่ใช่ขายที่แนวรับ). ถ้าตอนนี้ราคาอยู่ปลายกรอบผิดฝั่ง
(เช่น ชนแนวต้านอยู่ แต่จะแนะ long) ให้บอกชัดว่า **"รอราคากลับเข้าโซนก่อน (เช่น รอย่อลงแนวรับ 4485) อย่าเข้าที่แนวต้าน 4530"**
พร้อมระบุโซนราคา+เงื่อนไขเป็นรูปธรรมจาก 📐 — เพราะไล่ราคาสวนโซน (buy ใกล้แนวต้าน/sell ใกล้แนวรับ) = R:R แย่ พอร์ตเล็กแตกง่าย.
ถ้าราคาปัจจุบัน (gold_price/gold_tech.this_week.close) ยังไม่เข้าโซนของ algo ฝั่งที่แนะ → ระบุว่า "พักรอโซน" ไม่ใช่ "เข้าเลย".
ย้ำ: นี่คือคำแนะนำว่า "algo ไหนเหมาะ + ควรรอโซนไหน" เท่านั้น — ไม่ใช่คำสั่งเปิดไม้ ระบบ entry ตัดสินเองตามกฎของมัน.
